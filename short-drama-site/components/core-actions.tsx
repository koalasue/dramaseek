...
import { Cloud, MagnifyingGlass, Trophy } from "@phosphor-icons/react/dist/ssr";

export function CoreActions({ active }: { active: "search" | "rankings" | "library" }) {
  const items = [
    ...
    { id: "library", href: "/library", label: "My Library", detail: "管理云盘备份资源", icon: Cloud }
  ] as const;
